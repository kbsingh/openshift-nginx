...
Source1000: 	   headers-more-nginx-module-0.32.tar.gz
...
%endif
    ...
    --with-pcre \
    --with-pcre-jit \
    --with-stream=dynamic --add-module=../headers-more-nginx-module-0.32 \
...
%changelog
* Mon Mar 20 2017 Karanbir Singh <kbsingh@karan.org> - 1:1.10.2-2.dsaas
- Add additional_headers plugin
- build for dsaas 
